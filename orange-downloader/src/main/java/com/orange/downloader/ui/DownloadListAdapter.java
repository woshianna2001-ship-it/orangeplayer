...
import com.orange.downloader.R;
...
public class DownloadListAdapter extends RecyclerView.Adapter<DownloadListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.orange_download_item_task, parent, false);
    ...
    private void loadThumbnail(ViewHolder holder, VideoTaskItem item) {
        ...
        if (coverUrl != null && !coverUrl.isEmpty()) {
            Glide.with(mContext)
                .load(coverUrl)
                .placeholder(R.drawable.orange_download_ic_download)
                .error(R.drawable.orange_download_ic_download)
                .centerCrop()
        ...
        // 4. 默认图标
        holder.ivThumbnail.setImageResource(R.drawable.orange_download_ic_download);
    }
